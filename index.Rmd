...
---
### Exemple de données ouvertes : le [fichier des personnes décédées](https://www.data.gouv.fr/fr/datasets/fichier-des-personnes-decedees/)

![](img/deces.png)

---
### red[Exemple d'usage] : le [fichier des personnes décédées](https://www.data.gouv.fr/fr/datasets/fichier-des-personnes-decedees/)

[![](https://static.data.gouv.fr/images/90/4a69979666463f9a3297bef0d3c91a.png)](https://deces.matchid.io/)
---
class: inverse, center, middle
